loc_0:
        ...
        .4byte 0x00000000
loc_10:
        .asciz "menu2/sc_adv_result.pac"
loc_28:
        .4byte 0x25640000
loc_2C:
        .asciz "MenAdvResult0000_TopN"
        .balign 4
loc_44:
        .asciz "MenAdvResult0010_TopN"
        .balign 4
loc_5C:
        .4byte 0x5F5F3000
loc_60:
        ...
        .balign 4
loc_70:
        .4byte 0x00000000         [R_PPC_ADDR32(34, 5, "loc_F8")]
        .4byte 0x00000000
        .4byte 0x00000000         [R_PPC_ADDR32(34, 1, "muAdvResultTask__processDefault")]
...
loc_E8:
        .4byte 0x00000000         [R_PPC_ADDR32(34, 5, "loc_108")]
        .4byte 0x00000000
        .4byte 0x00000000
        .4byte 0x00000000
loc_F8:
        .4byte 0x00000000         [R_PPC_ADDR32(34, 5, "loc_D8")]
        .4byte 0x00000000         [R_PPC_ADDR32(34, 5, "loc_E8")]
loc_100:
        .asciz "gfTask"
        .balign 4
loc_108:
        .4byte 0x00000000         [R_PPC_ADDR32(34, 5, "loc_100")]
        .4byte 0x00000000
loc_110:
        .4byte 0x83748342
        .4byte 0x834D8385
